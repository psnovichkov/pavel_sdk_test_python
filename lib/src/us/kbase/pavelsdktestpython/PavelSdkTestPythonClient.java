...
/**
 * <p>Original spec-file module name: pavel_sdk_test_python</p>
 * <pre>
 * A KBase module: pavel_sdk_test_python
 * This sample module contains one small method - count_contigs.
 * </pre>
 */
public class PavelSdkTestPythonClient {
     ...
     */
    public PavelSdkTestPythonClient(URL url) {
     ...
     * validity.
     */
    public PavelSdkTestPythonClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public PavelSdkTestPythonClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * @return   instance of type {@link us.kbase.pavelsdktestpython.CountContigsResults CountContigsResults}
    ...
    public CountContigsResults countContigs(String arg1, String arg2, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<CountContigsResults> res = caller.jsonrpcCall("pavel_sdk_test_python.count_contigs", args, retType, true, true, jsonRpcContext);
        return res.get(0);
    }
