...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'pavel_sdk_test_python'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from pavel_sdk_test_python.pavel_sdk_test_pythonImpl import pavel_sdk_test_python
impl_pavel_sdk_test_python = pavel_sdk_test_python(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['pavel_sdk_test_python.count_contigs_async'] = ['pavel_sdk_test_python', 'count_contigs']
async_check_methods['pavel_sdk_test_python.count_contigs_check'] = ['pavel_sdk_test_python', 'count_contigs']
sync_methods['pavel_sdk_test_python.count_contigs'] = True
async_run_methods['pavel_sdk_test_python.get_person_async'] = ['pavel_sdk_test_python', 'get_person']
async_check_methods['pavel_sdk_test_python.get_person_check'] = ['pavel_sdk_test_python', 'get_person']
sync_methods['pavel_sdk_test_python.get_person'] = True
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "pavel_sdk_test_python but no authentication header was passed"
                            raise err
